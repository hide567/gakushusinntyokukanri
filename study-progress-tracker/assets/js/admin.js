...
jQuery(document).ready(function($) {
    ...
    $(document).on('click', '.section-tab', function() {
        ...
        // 節の詳細表示切り替え（すべて表示したまま、アクティブタブだけハイライト）
        // 必要に応じて詳細の表示/非表示を制御
     ...
     */
    $('.section-count').on('change', function() {
    ...
    function bindSectionEvents() {
        $('.section-tab').off('click').on('click', function() {
            $(this).siblings('.section-tab').removeClass('active');
            $(this).addClass('active');
            
            var chNum = $(this).data('chapter');
            var secNum = $(this).data('section');
            var subj = $(this).closest('.subject-section').data('subject-key');
            
            localStorage.setItem('spt_admin_activeSection_' + subj + '_' + chNum, secNum);
        });
    }
    ...
    function bindChapterEvents() {
        $('.chapter-tab').off('click').on('click', function() {
            var $subjectSection = $(this).closest('.subject-section');
            var subject = $subjectSection.data('subject-key');
            var chapterNum = $(this).data('chapter');
