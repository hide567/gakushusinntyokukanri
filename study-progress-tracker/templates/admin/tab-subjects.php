...
<div class="admin-section">
    <!-- 科目追加のアコーディオンヘッダー（修正版） -->
    <div class="subject-add-header" 
         data-action="toggle-add-form" 
         style="cursor: pointer; padding: 15px; background: #f8f9fa; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 20px; user-select: none;">
